...
class AudioManagerTests: XCTestCase {
    ...
    func testBackgroundMusicLoad() {
        XCTAssertNoThrow(try audioManager.playBackgroundMusic(resourceName: "Resources/musicTest.mp3"))
    }
    ...
    func testSoundLoad() {
        XCTAssertNoThrow(try audioManager.playSoundFX(resourceName: "Resources/soundTest.wav"))
    }
